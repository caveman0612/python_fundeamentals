...
home_Alone = Movie(2000, "home alone")
print(home_Alone.title, home_Alone.year, type(home_Alone))

Cute = RomCom(1990, "Awesome")
print(Cute.title)

bad_Ass = ActionMovie(2010, "Awesome", 17)
print(bad_Ass.year, bad_Ass.pg)
